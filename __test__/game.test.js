...
describe('Game', () => {
  ...
  describe('Game', () => {
    it.skip('Initializes with two players', async () => {
      expect(game.p1).toBe('Salem')
      expect(game.p2).toBe('Nate')
    })

    it.skip('Initializes with an empty board', async () => {
    ...
    it.skip('Starts the game with a random player', async () => {
      Math.random = () => 0.4
  ...
  describe('nextPlayer', () => {
    it.skip('Sets the current player to be whoever it is not', async () => {
      Math.random = () => 0.4
